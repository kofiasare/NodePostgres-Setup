...
export default {
    ...
    createUser: [
        ...
        .custom(value => customValidators.isUniqueEmail(value)).withMessage('email is already taken'),
        ...
        .custom((value, { req }) => customValidators.passwordConfirmation(value, req)).withMessage("Passwords don't match."),
    ],
